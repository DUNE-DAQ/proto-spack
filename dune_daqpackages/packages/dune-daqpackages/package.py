...
class DuneDaqpackages(BundlePackage):
    ...
    for build_type in ["Debug", "RelWithDebInfo", "Release"]:
        ...
        depends_on(f'daq-cmake@develop build_type={build_type}', when=f'@dunedaq-v2.8.2 build_type={build_type}')
        depends_on(f'trace@3.16.02 build_type={build_type}', when=f'@dunedaq-v2.8.2 build_type={build_type}')
        depends_on(f'listrev@2.1.4 build_type={build_type}', when=f'@dunedaq-v2.8.2 build_type={build_type}')
