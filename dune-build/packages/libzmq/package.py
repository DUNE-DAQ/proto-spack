...
class Libzmq(AutotoolsPackage):
    ...
    git      = "/home/spacknp/jcfree/repos/libzmq"

    version('master', branch='master')
    version('for_clang', branch='for_clang')
    ...
    depends_on('autoconf', type='build', when='@for_clang')
    depends_on('automake', type='build', when='@for_clang')
    depends_on('libtool', type='build', when='@for_clang')
