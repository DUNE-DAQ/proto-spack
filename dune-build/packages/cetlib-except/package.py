...
class CetlibExcept(CMakePackage):
    ...
    homepage = 'https://gitlab.cern.ch/dune-daq/experimental/externals/cetlib_except'
    git_base = 'https://gitlab.cern.ch/dune-daq/experimental/externals/cetlib_except.git'
    url = 'https://gitlab.cern.ch/dune-daq/experimental/externals/cetlib_except/-/archive/v1_07_04/cetlib_except-v1_07_04.tar.gz'
